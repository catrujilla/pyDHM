...
def info():
    ...
    print ("The available phase shifting algorithms are slightly off-axis synthetic references (SOSR), blind shift (BS) and the traditinal full in-line 3-step, 4-step and 5-step algorithms")
